...
//! atomic writes, filesystem [change watching](watch), [host
//! information](sysinfo), and [input event types](input). Windowing and GPU
//! surface creation depend on a compositor and arrive with the renderer in a
//! later phase.
